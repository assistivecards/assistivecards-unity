...
public class StackCardsUIController : MonoBehaviour
{
    [SerializeField] StackCardsBoardGenerator board;
    ...
    {
        progressChecker.levelsCompleted = 0;
    }
    ...
    {
        if (Input.touchCount == 1 || StackCardsBoardGenerator.isBackAfterSignOut)
        {
