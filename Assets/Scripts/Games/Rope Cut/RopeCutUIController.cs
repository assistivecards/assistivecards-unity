...
public class RopeCutUIController : MonoBehaviour
{
    [SerializeField] RopeCutBoardGenerator board;
    ...
    {
        if (Input.touchCount == 1 || RopeCutBoardGenerator.isBackAfterSignOut)
        {
