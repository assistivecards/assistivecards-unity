...
public class FingerPaintUIController : MonoBehaviour
{
    [SerializeField] FingerPaintBoardGenerator board;
    ...
    {
        if (Input.touchCount == 1 || FingerPaintBoardGenerator.isBackAfterSignOut)
        {
