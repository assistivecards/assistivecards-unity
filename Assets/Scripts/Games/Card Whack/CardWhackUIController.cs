...
public class CardWhackUIController : MonoBehaviour
{
    [SerializeField] CardWhackBoardGenerator board;
    ...
    {
        scoreManager.levelsCompleted = 0;
    }
    ...
    {
        if (Input.touchCount == 1 || CardWhackBoardGenerator.isBackAfterSignOut)
        {
