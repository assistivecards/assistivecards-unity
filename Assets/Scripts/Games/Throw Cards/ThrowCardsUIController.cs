...
public class ThrowCardsUIController : MonoBehaviour
{
    [SerializeField] ThrowCardsBoardGenerator board;
    ...
    {
        if (Input.touchCount == 1 || ThrowCardsBoardGenerator.isBackAfterSignOut)
        {
